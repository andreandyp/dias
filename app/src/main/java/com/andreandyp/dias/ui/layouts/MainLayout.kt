...
private fun ExpandedConfiguration(alarm: AlarmUiState, onChangeRingtone: (AlarmUiState) -> Unit) {
    AnimatedVisibility(
        ...
        OutlinedButton(
            onClick = { onChangeRingtone(alarm) },
            modifier = Modifier.padding(horizontal = 16.dp),
        ) {
            Icon(
                imageVector = if (alarm.ringtoneName != null) {
            ...
            Text(
                text = alarm.ringtoneName ?: stringResource(id = R.string.choose_song_alarm_config),
            )
        }
    }
        ...
        Surface {
            MainLayout(
                ...
                listOf(
                    ...
                    alarm.copy(isConfigExpanded = true, ringtoneName = "Nuevo amanecer"),
                    alarm,
                    alarm,
                    alarm,
                    alarm,
